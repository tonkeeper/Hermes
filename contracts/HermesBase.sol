 ...
 *      ERC-677, and an ERC-777 hook reachable only after ERC-1820 self-registration — see
 *      `tokensReceived`), ERC-165 introspection over them, and the ERC-7779 surface a wallet reads
...
abstract contract HermesBase is IERC165, IERC7779, IERC721Receiver, IERC1155Receiver {
    ...
    /// @notice ERC-777 `tokensReceived` hook. No-op: the transfer is accepted as-is (ERC-777
    ///         signals acceptance by not reverting, so there is no return value).
